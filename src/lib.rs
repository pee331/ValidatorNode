// src/lib.rs
/*
 * Core library for ValidatorNode
 */
...
#[derive(Debug)]
pub struct ValidatorNodeProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ValidatorNodeProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ValidatorNode processing");
    
    let mut processor = ValidatorNodeProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ValidatorNodeProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ValidatorNodeProcessor::new(false);
